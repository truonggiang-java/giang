...
public class ProductDto {
	...
	public ProductDto(String name, int discount, String description, Integer category, Integer brands, Integer priority,
			boolean status, String slug, Set<OptionDto> options, Set<SkusDto> skus) {
		super();
		this.name = name;
		this.discount = discount;
		this.description = description;
